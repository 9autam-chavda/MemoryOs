      ...
      <div className="w-full max-w-2xl rounded-lg border border-white/[0.08] bg-[var(--surface-panel)] shadow-[0_30px_90px_rgba(0,0,0,0.55)]">
        <div className="flex items-start justify-between gap-4 border-b border-white/[0.07] p-5">
          <div>
            ...
            <h2 id="upload-modal-title" className="mt-1 text-xl font-semibold text-zinc-100">Add source material to your second brain</h2>
            <p id="upload-modal-description" className="mt-2 max-w-xl text-sm leading-6 text-zinc-500">
        ...
        <div className="p-5">
          <label
            ...
            className="flex cursor-pointer flex-col items-center justify-center rounded-lg border border-dashed border-white/[0.14] bg-zinc-950 px-6 py-12 text-center transition hover:border-[var(--accent)]/70 hover:bg-white/[0.035]"
          >
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-white/[0.07] p-5 sm:flex-row sm:justify-end">
          <button
            ...
            onClick={handleClose}
            ref={closeButtonRef}
            className="rounded-lg border border-white/[0.08] bg-white/[0.035] px-4 py-2.5 text-sm font-medium text-zinc-300 transition hover:border-white/[0.14] hover:text-zinc-100"
          >
            Cancel
          </button>
